        ...
        data.forEach(v => {
            ...
            raw += `
                <tr>
                    ...
                    <td align="center">${v.temperature_node} <small>°C</small></td>
                    <td align="center">${v.humidity_node} <small>%</small></td>
                    <td align="center">${v.dissolver_oxygen} <small>mg/L</small></td>
                    <td align="center">${v.turbidity} <small>NTU</small></td>
                    <td align="center">${v.salinity} <small>PSU</small></td>
                    <td align="center">${v.cod}<small>mg/L</small></td>
                    <td align="center">${v.ph}pH</td>
                    <td align="center">${v.orp} <small>mV</small></td>
                    <td align="center">${v.tds} <small>ppm</small></td>
                    <td align="center">${v.nitrat} <small>mg/L</small></td>
                    <td align="center">${v.temperature_air} <small>°C</small></td>
                    <td align="center">${v.tss} <small>mg/L</small></td>
                    <td align="center">${v.debit_air} <small>m3/s</small></td>
                    <td align="center">${v.water_level_cm} <small>m3/s</small></td>
                    <td align="center"><span class="badge rounded-pill ${v.status_pompa == 1 ? 'bg-success' : 'bg-danger'}">
                        ${v.status_pompa == 1 ? 'Hidup' : 'Mati'}</span>
                    </td>
                    </tr>
            `;
        });
